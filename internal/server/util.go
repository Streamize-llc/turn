...
func authenticateRequest(r Request, m *stun.Message, callingMethod stun.Method) (string, stun.MessageIntegrity, bool, error) {
	respondWithNonce := func(responseCode stun.ErrorCode) (string, stun.MessageIntegrity, bool, error) {
	...
	return usernameAttr.String(), stun.MessageIntegrity(ourKey), true, nil
}
